export default function CustomNavbar(props) {
    return (
        <nav className="navbar navbar-light align-items-center" style={{ backgroundColor: props.dark ? "rgb(39,39,39)" : '#f9f9f9', borderBottom: props.dark ? '1px solid #343a40' : '1px solid rgb(222,222,222)',height:'7vh',alignItems:'center',paddingTop:'15px' }}>
