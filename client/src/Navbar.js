        ...
        <nav className="navbar navbar-light" style={{ backgroundColor: props.dark ? "rgb(39,39,39)" : '#f9f9f9', borderBottom: props.dark ? '1px solid #343a40' : '1px solid rgb(222,222,222)' }}>
            <div className="container-fluid">
                ...
                <div style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <Button title="Login" onClick={() => handleClickOpen()} size="medium" sx={{ height: '35px', marginTop: '2px', fontSize: '12.95px', color: 'white', fontFamily: 'Source Code Pro', textTransform: 'lowercase', marginRight: '4px' }}>
                    ...
                    <Dialog open={open} onClose={handleClose}>
                        ...
                        <DialogActions>
                            <Button sx={{fontFamily: 'Source Code Pro'}} onClick={handleClose}>Signup</Button>
                            <Button sx={{fontFamily: 'Source Code Pro'}} onClick={handleClose}>Login</Button>
                        </DialogActions>
                    </Dialog>
