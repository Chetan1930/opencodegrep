...
export const Output = (props) => {
    return (
        <div className="output" style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', paddingLeft: '0.8vw', backgroundColor: props.bgcol, marginTop: '-8px', paddingTop: '40px', overflowY: 'scroll', position: 'relative', height: '22.5vh', fontSize: '0.98em', borderTop: `0.1px solid ${props.border}`, color: props.col }}>
